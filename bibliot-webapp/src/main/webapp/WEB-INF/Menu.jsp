 ...
 <nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand bg-light text-warning" href="/bibliot-webapp/home" >
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
     ...
     <c:choose>
							<c:when test="${sessionScope.connected}">
								<li class="nav-item"><a href="/bibliot-webapp/loginPage">
						...
						<li class="nav-item"><a href="/bibliot-webapp/exit"><span
        ...
        <%-- <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li role="separator" class="divider"></li>
				...
				<c:otherwise>
				<li class="nav-item">Connectez-vous</li>
			</c:otherwise>
		</c:choose>
